...
mkdir -p models/first_stage_models/kl-f4 models/first_stage_models/kl-f8 models/first_stage_models/kl-f16
mkdir -p models/first_stage_models/kl-f32 models/first_stage_models/vq-f4 models/first_stage_models/vq-f4-noattn
mkdir -p models/first_stage_models/vq-f8 models/first_stage_models/vq-f8-n256 models/first_stage_models/vq-f16
